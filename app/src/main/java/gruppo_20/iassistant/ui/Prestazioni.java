...
class Prestazioni {
        ...
        public static final Prestazioni[] items = {new Prestazioni("Anamnesi Dietologica","1",true                                                                                                                                                                                                                                                                                              ),
                new Prestazioni("Misurazione Pressione","2",false),new Prestazioni("Terapia Iniettiva","3",true                                                                                                                                                                                                                                                                                              ),
                new Prestazioni("Misurazione Pressione","2",false),new Prestazioni("Terapia Iniettiva","1",true                                                                                                                                                                                                                                                                                              ),
                new Prestazioni("Misurazione Pressione","2",false),new Prestazioni("Terapia Iniettiva","1",true                                                                                                                                                                                                                                                                                              ),
                new Prestazioni("Misurazione Pressione","2",false)};
